        ...
        {projects?.map((project, i) => (
          <div className='w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen' key={project._id}>
            <motion.img
              ...
              viewport={{once: true}}
              src={project.image ? urlFor(project.image).url() : "https://w7.pngwing.com/pngs/640/199/png-transparent-javascript-logo-html-javascript-logo-angle-text-rectangle-thumbnail.png"} alt="project" />
